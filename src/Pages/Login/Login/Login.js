...
const Login = () => {
    ...
    return (
        <div className='container w-50 mx-auto'>
            ...
            <p className='mt-2'>Forget Password? <button onClick={forgetPassword} className='btn btn-link text-primary text-decoration-none pe-auto'>Reset Password</button></p>
